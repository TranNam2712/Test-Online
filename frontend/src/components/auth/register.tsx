...
import { registerSchema, type RegisterSchemaType } from "../../utils/validate";
          ...
          <Stack spacing={4}>
            ...
            <FormControl isInvalid={!!errors.acceptTerms}>
              <Checkbox {...register("acceptTerms")}>
                <Text fontSize="sm">
                  I agree to the <Link color="teal.500">Terms of Service</Link>{" "}
                  and <Link color="teal.500">Privacy Policy</Link>
                </Text>
              </Checkbox>
              <FormErrorMessage>
